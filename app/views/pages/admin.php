...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active " aria-current="page" href="<?php echo URLROOT; ?>/pages/admin">reservation</a>
  </li>
  <li class="nav-item">
...
<div class="container ">
    ...
    <div class="row mt-4">
      ...
      <!-- =============================================== -->
                <a href="<?php echo URLROOT; ?>/pages/adminport"  >
                <i class="fa-regular fa-plus"></i>
                </a>

               <a href="<?php echo URLROOT; ?>/pages/adminport" class=" btn btn-primary ml-3">

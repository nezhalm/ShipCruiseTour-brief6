    ...
    <div class="col-md-10 mx-auto">
      ...
      <div class="card">
        ...
        <div class="card-body bg-light">
          <!-- ==recherche============================== -->
          <form action="<?php echo URLROOT; ?>/produits/searchProduit" method="post" class="float-right d-flex flex-row mb-2 ">
          ...
          <div style="display: flex; ">
            <div class="dropdown" style="margin-top: 10px; margin-bottom: 10px;  margin-right: 10px; ">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <a href="<?php echo URLROOT; ?>/produits/tridecroissant" class="dropdown-item" type="button">decroissant</a>
            ...
            <div class="dropdown" style="margin-top: 10px; margin-bottom: 10px;">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <a href="<?php echo URLROOT; ?>/produits/tridecroissant_date" class="dropdown-item" type="button">decroissant</a>
                <a href="<?php echo URLROOT; ?>/produits/croissant_date" class="dropdown-item" type="button">croissant</a>
              </div>
            </div>
          </div>
              ...
              <?php if ($data['produit']) :
                foreach ($data['produit'] as $produit) : ?>
                  <tr>
                    ...
                    <td> <a class="btn btn-sm btn-warning" href="<?php echo URLROOT ?>/produits/delete/<?php echo $produit->id_produit ?> "><i class="fa fa-trash"></i></a>

                    </td>
   <td>     <a  class="btn btn-dark" href="<?php echo URLROOT?>/produits/edit/<?php echo $produit->id_produit ?>"><i class="fa fa-edit"></i></a>
</td>

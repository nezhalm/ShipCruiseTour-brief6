...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo URLROOT; ?>/ports/adminport">port</a>
  </li>
  <li class="nav-item">
    <a class="nav-link " href="<?php echo URLROOT; ?>/navires/adminnavire">navire</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active " href="<?php echo URLROOT; ?>/croisiers/admincroisier">croisier</a>
  </li>
</ul>
  ...
  <table class="table">
      ...
      <?php if ($data['croisier']): foreach ($data['croisier'] as $croisier): ?>
	   <tr>
        ...
        <td><?php echo $croisier->itenaire1."/".$croisier->itenaire2."/".$croisier->itenaire3; ?></td>
        <td><img src="<?php echo URLROOT.'/img/'.$croisier->image; ?>" width="80px" height="80px"></td>

        <td> <a class="btn btn-sm btn-warning"
                        onclick="deletItem('<?php echo URLROOT ?>/croisiers/delete/<?php echo $croisier->id ?>')"><i
